...
class ReplaceOrderRequest(ApiRequest):
    def __init__(self):
        ApiRequest.__init__(self, "/trade/order/replace", method="POST", body_params={})
    ...
    def set_stock_order(self, client_order_id, instrument_id, side, tif, order_type, entrust_type,
        ...
        stock_order_params["order_id"] = stock_order_params.pop("client_order_id")
    ...
    def set_option_order(self, client_order_id, side, tif, order_type, option_strategy, limit_price=None,
        ...
        option_order_params["order_id"] = option_order_params.pop("client_order_id")
    ...
    def set_crypto_order(self, client_order_id, instrument_id, side, tif, order_type, entrust_type,limit_price=None,
        ...
        crypto_order_params["order_id"] = crypto_order_params.pop("client_order_id")
